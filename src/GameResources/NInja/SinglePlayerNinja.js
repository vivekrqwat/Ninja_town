...
export class SinglePlayerNinja extends Phaser.Physics.Arcade.Sprite{
...
// }
    ...
    if(this.keyX.isDown&&!this.isWeponAttack){
         ...
         this.s.time.delayedCall(300, () => { // pick a cooldown that feels right
        this.isWeponAttack = false;
    });
    ...
    if(this.keyS.isDown&&!this.isAttacking){
      ismoving=false;
        ...
        this.playerAttck("attacko4","explosion");
 ...
 if (aniname == "attacko1") {
    ...
    wepoanattack(name){
         ...
         if(name=="shuriken"){
            ...
            // this.kunia= CreateNinjaAndAtaacks(this.s,this.x,this.y+100,name).setScale(2)
            //     this.kunia.setVelocityY(+500)
                 this.kunai(this.s,this.x,this.y+10,name,+500,"down");
        ...
        //     this.kunia.setVelocityX(-500)
             this.kunai(this.s,this.x-10,this.y,name,-500,"left");
            ...
            // this.kunia= CreateNinjaAndAtaacks(this.s,this.x+100,this.y,name).setScale(2)
            //         this.kunia.setVelocityX(500)
                                 this.kunai(this.s,this.x+10,this.y,name,+500,"right");
    ...
    this.kunia = CreateNinjaAndAtaacks(s,x,y,name).setScale(2).setCollideWorldBounds(false);
         ...
         if(dir=="up"||dir=="down"){
            ...
            const thisKunai = this.kunia;
    s.time.delayedCall(1500, () => {
        if (thisKunai && thisKunai.active) {
            thisKunai.destroy();
        }
    });
